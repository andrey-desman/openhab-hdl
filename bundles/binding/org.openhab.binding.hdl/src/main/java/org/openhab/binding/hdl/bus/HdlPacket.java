...
class HdlPacket
{
  ...
  protected static final int[] CRC =
  {
  ...
  protected static int ubyte(byte a) { return  ( (int) a) & 0xff; }
  protected static int ushort(byte h, byte l) {
    return  (((short)h << 8) & 0xff00 ) | ( (short)l & 0xff );
  }
  ...
  public String toString()
  {
    return "[" + Integer.toHexString(sourceAddress)
      + " -> " + Integer.toHexString(targetAddress) + " : " + Integer.toHexString(command) + "]";
  }
  ...
  public void setTargetAddress(int a) { targetAddress = a & 0xffff; }
  ...
  public byte[] getBytes()
  {
    ...
    p[i++] = (byte)(targetAddress >> 8); // tgt subnet
    p[i++] = (byte)targetAddress; // tgt device id
